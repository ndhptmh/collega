            ...
            <div class="page-body-wrapper horizontal-menu">
                ...
                <header class="main-nav">
                    <div class="sidebar-user text-center">
                        ...
                        <a href="/profile"> <h6 class="mt-3 f-14 f-w-600">{{ucfirst(auth()->user()->name)}}</h6></a>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="pull-right mb-0">Aplikasi by Mobidu with <i class="fa fa-heart font-secondary"></i></p>
                            </div>
                        </div>
                    </div>
                </footer>
